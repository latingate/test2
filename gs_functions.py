...
def open_mongodb_connection():
    ...
    # db = conn['tstdb']['tst2']
    conn = MongoClient(
        'mongodb+srv://latingate:mgal5313b@cluster0.oss2v.mongodb.net/test?authSource=admin&replicaSet=atlas-wgu8qa-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true')
